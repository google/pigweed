...
TEST(Boringssl, UseAes) {
  ...
  // module.
  alignas(16) const UInt128 irk{{0x9B,
                                 0x7D,
                                 0x39,
                                 0x0A,
                                 0xA6,
