...
using ::pw::containers::size_report::MeasureIntrusiveMultiMap;
...
int Measure() {
  ...
  static std::array<FastSortedItem<BlockType>, kNumItems> items;
  if (int rc = MeasureIntrusiveMultiMap<size_t, FastSortedItem<BlockType>>(
  ...
  static FastSortedBucket<BlockType> bucket;
