...
TEST(InstrusiveList, DeleteHeadWhileIterating) {
  // Create a list with some items it.
  std::array<TestItem, 5> items{{{1}, {1}, {2}, {3}, {4}}};
  IntrusiveList<TestItem> list(items.begin(), items.end());
...
TEST(InstrusiveList, DeleteMiddleWhileIterating) {
  // Create a list with some items it.
  std::array<TestItem, 5> items{{{1}, {1}, {2}, {3}, {4}}};
  IntrusiveList<TestItem> list(items.begin(), items.end());
  ...
  EXPECT_EQ(&items[0], &(*it++));
  EXPECT_EQ(&items[1], &(*it++));
  // Middle element has been removed.
  EXPECT_EQ(&items[3], &(*it++));
  EXPECT_EQ(&items[4], &(*it++));
  EXPECT_EQ(list.end(), it);
}

TEST(InstrusiveList, DeleteTailWhileIterating) {
  // Create a list with some items it.
  std::array<TestItem, 5> items{{{1}, {1}, {2}, {3}, {4}}};
  IntrusiveList<TestItem> list(items.begin(), items.end());
...
TEST(InstrusiveList, DeleteAllWhileIterating) {
  // Create a list with some items it.
  std::array<TestItem, 5> items{{{1}, {1}, {2}, {3}, {4}}};
  IntrusiveList<TestItem> list(items.begin(), items.end());
...
TEST(InstrusiveList, DeleteOnlyElementIterating) {
  // Create a list with some items it.
  std::array<TestItem, 1> items{{{1}}};
  IntrusiveList<TestItem> list(items.begin(), items.end());
