...
/// Creates the system allocator and returns a pointer top it.
///
/// This function must be implemented to return a pointer to an allocator with a
/// global lifetime. The returned allocator must be ready to use. The facade
/// will call this function at most once.
///
...
///
/// @param  system_allocator  System allocator mtaching the one returned by
///                           `CreateSystemAllocator`. This may differ from the
///                           one returned by `GetSystemAllocator`.
...
///
/// @param  heap_low_addr     Inclusive start of the region of memory to use as
///                           a heap. This MUST be less than `heap_high_addr`.
/// @param  heap              Exclusive end of the region of memory to use as
///                           a heap. This MUST be less than `heap_high_addr`.
