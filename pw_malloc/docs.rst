...
* :cc:`PW_MALLOC_LOCK_TYPE`
* :cc:`PW_MALLOC_METRICS_TYPE`
* :cc:`PW_MALLOC_BLOCK_OFFSET_TYPE`
* :cc:`PW_MALLOC_MIN_BUCKET_SIZE`
* :cc:`PW_MALLOC_NUM_BUCKETS`
* :cc:`PW_MALLOC_DUAL_FIRST_FIT_THRESHOLD`
