...
class ServerTest : public TestingBase {
 ...
 protected:
  void SetUp() override {
    ...
    l2cap_->AddACLConnection(kTestHandle1, pw::bluetooth::emboss::ConnectionRole::PERIPHERAL,
                             nullptr, nullptr);
    l2cap_->AddACLConnection(kTestHandle2, pw::bluetooth::emboss::ConnectionRole::PERIPHERAL,
                             nullptr, nullptr);
